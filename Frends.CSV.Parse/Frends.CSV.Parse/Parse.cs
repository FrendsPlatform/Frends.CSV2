...
public static class CSV
{
    ...
    /// <returns>Object { bool Success, List&lt;List&lt;object&gt;&gt; Data, List&gt;string&lt; Headers, string ConfigurationCultureInfo, Error Error }</returns>
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            return new Result
            {
                ...
                Data = resultData,
                Headers = headers,
                ConfigurationCultureInfo = cultureInfo.Name,
            };
        }
        catch (Exception ex)
        {
    ...
    /// <returns>Type corresponding to the ColumnType enum value.</returns>
