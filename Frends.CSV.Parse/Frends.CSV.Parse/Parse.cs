...
public class CSV
{
    ...
    /// <returns>Object { bool Success, List&lt;List&lt;object&gt;&gt; Data, List&gt;string&lt; Headers, string ConfigurationCultureInfo, object Jtoken, string Xml }</returns>
    ...
    private static string WriteXmlString(IEnumerable<List<object>> data, CultureInfo culture,
    ...
    private static object WriteJToken(IEnumerable<List<object>> data, CultureInfo culture,
        IReadOnlyList<string> headers)
    {
